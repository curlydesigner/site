...
- **Main HUD and Navigantion** - [UX Size Guide and Accessibility](/wb-accessibility)
...
- **Dragon Collection** Resources and Empire Management like food production, manage their city, dragons and make other strategic decisions.
...
The HUD consist a top bar with elements that are persistent. 
...
- Page Title; in the header should indicate the current location or purpose of the local navigation panel.
...
**Close Button or Tap Outside** - should be used to dismiss or close a specific element, small pop outs, overly screens, information panels.
...
The information panel open a tool tip to show territory ownership and offer CTA. 
...
- [UX Size Guide and Accessibilty](/wb-accessibility)
