...
#### Complexity
  ...
  Cluttered / Complex Interfaces & Information Overload 4X games overwhelm with cluttered or unintuitive interfaces, making it difficult for players to find the specific data they need or get lost in irrelevant details.
...
Some players find the visual aesthetics lack of clarity & readability. Make it difficult for players to quickly grasp the current game state, leading to confusion or mistakes.
...
![touch target](assets/posts/2023-06-31-p_wb-4x/wb-feaut-img.png "touch target")
