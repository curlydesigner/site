...
![ixd user flow](/assets/posts/2023-06-31-p_wb-4x/featureimage2.png "ixd user flow")
...
- One of the challanges I needed to ensure, the user interface (UI) provides clear and organized information about resources and ownership castles. 
