...
- Ensure the user interface (UI) provides clear and organized information about resources and ownership castles. Some of the questions I needed to explore were how to simplify for players:
