...
![ixd user flow](/assets/posts/2023-06-31-p_wb-4x/wb_featureimage2.png "ixd user flow")
...
<br>
- 
While working in WB Games I was involved in exploring Main HUD Navigation for a 4X strategy game. Creating 
In this type of strategy game the focuse on four core gameplay elements: Explore, Expand, Exploit, and Exterminate.
...
#### The main screens I was involved:

<br>

- Main HUD and Navigantion see Acessability and Size Guide
- A Map -  where players can see the entire game world and explore different tiles, castles and armies.
- UI Elements and navigation throughout the game - from selecting a tile, research and explore ownership, act to improve resource management and expanding an empire.
- Queast and Objective screen - where player can see alist of their objectives and interact, taking steps in progressign throughout the game. 
